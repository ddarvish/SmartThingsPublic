...
def lockAndCheck(doorLockMode, delay=5200) {
secureSequence([
...
def unlockwtimeout() {
lockAndCheck(DoorLockOperationSet.DOOR_LOCK_MODE_DOOR_UNSECURED_WITH_TIMEOUT,5200)
}
...
def secureSequence(commands, delay=5200) {
